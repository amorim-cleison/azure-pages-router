...
class RouterFunction():
        ...
        try:
            ...
            if originUrl is None:
                raise MissingArgumentError(
                    f"Parameter '{ORIGIN_URL_PARAM}' was not provided")
            ...
            if targetUrl is None:
                raise RouteNotFoundError(
                    "No route URL found for the path informed")
    ...
    def __parse_to_url(self, originUrl):
        try:
            ...
            raise InvalidArgumentError(
                f"Invalid URL provided in the '{ORIGIN_URL_PARAM}' parameter") from e
    ...
    def __read_as_post(self, req):
        originUrl = None
        logging.info(
            f"Trying to read '{ORIGIN_URL_PARAM}' from POST parameters...")
    ...
    def __process_response(self, targetUrl):
        return func.HttpResponse(headers={'Location': targetUrl},
    ...
    def __process_error_response(self, error):
        ...
        if message is None:
            message = "Failed to resolve target URL"
